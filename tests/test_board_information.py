from src import BoardInformation
...
class TestInit(unittest.TestCase):
    ...
    def test_empty_list(self):
        self.assertRaises(ValueError, BoardInformation([], 10000))

    def test_low_max_cash(self):
        self.assertRaises(BoardError, BoardInformation(["red"], 0))

    def test_maximum_players(self):
        self.assertRaises(BoardError, BoardInformation([str(i) for i in range(10)], 1500))

    def test_no_duplicate_player_names(self):
        self.assertRaises(BoardError, BoardInformation(["red", "red"], 10000))
