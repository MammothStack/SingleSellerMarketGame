...
class TestInit(unittest.TestCase):
    ...
    def test_no_duplicate_player_names(self):
        self.failUnlessRaises(BoardError, Board, *["red", "red"])
...
class TestCanUpgrade(unittest.TestCase):
    ...
    def test_can_upgrade_no_hotels(self):
        bi = Board(*["red","blue"], available_houses=20, available_hotels=0)
...
class TestUpgrade(unittest.TestCase):
    ...
    def test_houses_decline(self):
        bi = Board(*["red","blue"], available_houses=20, available_hotels=4)
